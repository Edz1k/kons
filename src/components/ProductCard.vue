...
<template>
  ...
  >
    ...
    <div class="absolute left-3 top-3 z-10">
      ...
      >
        <span
          ...
          :class="product.in_stock ? 'bg-emerald-300' : 'bg-rose-300'"
        />
    ...
    <div class="relative h-56 w-full overflow-hidden">
      <img
        v-if="product.images?.[0]?.directus_files_id"
        :src="fileUrl(product.images[0].directus_files_id)"
    ...
    <div class="p-4">
      ...
      <div class="mt-2 flex items-center justify-between">
        <div class="text-sm opacity-70">
          Артикул: <span class="opacity-90">{{ product.slug }}</span>
        </div>

        <div v-if="product.price !== undefined" class="text-base font-bold tracking-tight">
